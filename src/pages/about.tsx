...
export default function About({ children, title = "" }: ComponentProps) {
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10">
                  ...
                  <div className="flex w-1/2 justify-between mt-10">
                    {navigation.map((item) => (
                        <Link
                            ...
                            router.pathname === '/about' && item.href === '/about' ? 'border' : ''
                            }`}
                        >
                            {item.name}
                        </Link>
        ...
        <div className='items-center justify-center w-1/2'>
              ...
              <p className='text-white font-inter text-center mt-10 text-sm'>
                  Welcome to TravelBlog Philippines! We are your ultimate guide to exploring the beauty of the Philippines. Our mission is to provide you with comprehensive information about the breathtaking landscapes, vibrant culture, and hidden gems of this tropical paradise. Whether you're a seasoned traveler or planning your first adventure, let TravelBlog be your companion in discovering the wonders of the Philippines.
              </p>
          </div>
        </main>
      </div>
