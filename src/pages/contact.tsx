...
export default function Contact({ children, title = "" }: ComponentProps) {
                  ...
                  <div className="flex w-1/2 justify-between mt-10">
                    {navigation.map((item) => (
                        <Link
                            ...
                            router.pathname === '/contact' && item.href === '/contact' ? 'border' : ''
                            }`}
                        >
                            {item.name}
                        </Link>
        ...
        <main className='flex items-center justify-center'>
          <div className='items-center justify-center w-1/2'>
              ...
              <p className='text-white text-center mt-10'>
                  Need to get in touch with us? Fill out the form below or send us an email at contact@travelblog.ph. We'll get back to you as soon as possible.
              </p>
              <div className="flex justify-center mt-8">
                <FaFacebookSquare className="text-white mr-4" size={32} />
                <FaInstagram className="text-white mr-4" size={32} />
                <FaTwitter className="text-white mr-4" size={32} />
                <FaYoutube className="text-white mr-4" size={32} />
              </div>
          </div>
        </main>
      </div>
